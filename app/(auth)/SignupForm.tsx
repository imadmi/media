...
const formSchema = z
    ...
    .refine((data) => data.password === data.confirmPassword, {
        ...
        path: ['confirmPassword'], // This sets the error for confirmPassword field
    });
    ...
    return (
        <View className="w-full gap-3 mt-2">
            ...
            <Button
                ...
                className="bg-white text-white w-full flex-row justify-center items-center h-12 rounded-[9999px]"
